...
if v:version > 703 || v:version == 703 && has('patch1170')
  function! vital#_aref_web#Vim#ScriptLocal#import() abort
    return map({'scriptnames': '', 'sid2path': '', 'sid2sfuncs': '', 'sfuncs': '', 'svars': '', 'sid': '', 'sid2svars': ''},  'function("s:" . v:key)')
  endfunction
else
  function! s:_SID() abort
    return matchstr(expand('<sfile>'), '<SNR>\zs\d\+\ze__SID$')
  endfunction
  execute join(['function! vital#_aref_web#Vim#ScriptLocal#import() abort', printf("return map({'scriptnames': '', 'sid2path': '', 'sid2sfuncs': '', 'sfuncs': '', 'svars': '', 'sid': '', 'sid2svars': ''}, \"function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
  delfunction s:_SID
endif
" ___vital___
